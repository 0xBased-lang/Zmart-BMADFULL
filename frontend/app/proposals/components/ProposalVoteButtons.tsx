...
import { useProposalVoteSubmit } from '@/lib/hooks/useProposalVoteSubmit'

interface ProposalVoteButtonsProps {
  proposalId: string
}

export function ProposalVoteButtons({ proposalId }: ProposalVoteButtonsProps) {
  const { connected } = useWallet()
  const { submitVote, isSubmitting, userVote } = useProposalVoteSubmit()
